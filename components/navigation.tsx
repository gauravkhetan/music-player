...
import { Album, Heart, Home, Library, ListMusic, LogOut, Mic2 } from "lucide-react";
    ...
    <>
      <aside className="fixed inset-y-0 left-0 z-30 hidden w-60 border-r border-border bg-background px-4 py-6 lg:block">
        <div className="flex h-full flex-col">
          ...
          <form action={logout} className="mt-auto border-t border-border pt-4">
            <button
              type="submit"
              className="flex h-11 w-full items-center gap-3 rounded-md px-3 text-sm font-semibold text-muted transition hover:bg-white/10 hover:text-white"
            >
